...
std::string
IgnorePattern::convertGitPatternToRegex(const std::string &git_pattern) {
...
bool isFileIgnoredByIgnorePatterns(const std::string &filePath,
...
bool isFileIgnoredByPatterns(const std::string &file_path,
